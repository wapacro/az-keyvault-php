...
class KeyTest extends TestCase {
	 ...
	 */
	public function testGetKeyByNameAndVersion() {
		...
		$expectedKeyEntity = new KeyEntity(
			...
			'AQAB', '2HJAE5fU3Cw2Rt9hEuq-F6XjINKGa-zskfISVqopqUy60GOs2eyhxbWbJBeUXNor_gf-tXtNeuqeBgitLeVa640UDvnEjYTKWjCniTxZRaU7ewY8BfTSk-7KxoDdLsPSpX_MX4rwlAx-_1UGk5t4sQgTbm9T6Fm2oqFd37dsz5-Gj27UP2GTAShfJPFD7MqU_zIgOI0pfqsbNL5xTQVM29K6rX4jSPtylZV3uWJtkoQIQnrIHhk1d0SC0KwlBV3V7R_LVYjiXLyIXsFzSNYgQ68ZjAwt8iL7I8Osa-ehQLM13DVvLASaf7Jnu3sC3CWl3Gyirgded6cfMmswJzY87w',
		);
	 ...
	 */
	public function testGetKeyByVersionReference($versionReference) {
		$this->clientMock->method('get')->willReturn(json_decode(json_encode([
			'key' => [
				'kid' => 'https://kv-sdk-test.vault-int.azure-int.net/keys/mykeyname/4387e9f3d6e14c459867679a90fd0f79',
				'kty' => 'RSA',
